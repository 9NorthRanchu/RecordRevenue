...
| ส่วน | สถานะ |
|---|---|
| บิล | ✅ เขียนลงฐานจริงแล้ว |
| กระเป๋า · สกุลเงิน · เติมเงิน · ปิดทริป | 🔒 ยังล็อก (API พร้อมแล้ว รอต่อหน้าจอ) |
...
**ทดสอบแล้ว 40 เคสด้วย Chromium จริง** — `node frontend/trip-unified-prototype/live-mode.test.mjs` · เสิร์ฟไฟล์เอง + API ปลอมที่คืนรูปเดียวกับของจริง **ไม่ยิงฐานจริงเลย** · ครอบคลุมทั้งโหมดปกติ · โหมดจริง · กรณี API ล้ม · และ console สะอาด
