...
new_icon_logic = """        let iconElement = '';
        let bgColor = '#a2d2ff'; // default blue
...
old_card = """                    <div style="width: 42px; height: 42px; border-radius: 12px; background: ${bgColor}; display: flex; align-items: center; justify-content: center; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1), inset 0 2px 4px rgba(255,255,255,0.5); margin-top: 2px;">
                        ${innerIcon}
                    </div>"""
new_card = """                    ${iconElement}"""
