...
# Find the Debt Profile Modal block
...
if start_idx == -1 or end_idx == -1:
    print("Could not find the debt modal!")
    exit(1)

new_modal = """<!-- Debt Profile Modal -->
    <div id="debt-modal" class="modal-overlay" style="display: none; align-items: center; justify-content: center; z-index: 1000;">
        <div class="modal-content" style="width: 95%; max-width: 650px; background: rgba(248, 250, 252, 0.95); backdrop-filter: blur(12px); border-radius: 20px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.4); max-height: 90vh; display: flex; flex-direction: column; overflow: hidden;">
            <div class="modal-header" style="padding: 15px 25px; border-bottom: 1px solid rgba(226, 232, 240, 0.8); display: flex; justify-content: space-between; align-items: center; background: rgba(255, 255, 255, 0.5);">
            ...
            <div class="modal-body" style="padding: 15px 25px; overflow-y: auto;">
                <form id="debt-form" onsubmit="saveDebtProfile(event)">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-start;">
                        ...
                        <!-- Left: Icon Selector -->
                        <div style="flex: 1 1 200px; max-width: 280px; margin: 0 auto;">
                            <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 5px; display: block;">Icon Style</label>
                            <div style="background: rgba(255,255,255,0.8); border-radius: 12px; padding: 10px; border: 1px solid rgba(226, 232, 240, 0.8);">
                                <div class="icon-tabs" style="display: flex; gap: 4px; margin-bottom: 10px; overflow-x: auto; white-space: nowrap; scrollbar-width: none; -ms-overflow-style: none;">
                                    <button type="button" class="btn btn-sm btn-outline active" onclick="switchIconTab('zodiac')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">Zodiac</button>
                                    <button type="button" class="btn btn-sm btn-outline" onclick="switchIconTab('hokkaido')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">Hokkaido</button>
                                    <button type="button" class="btn btn-sm btn-outline" onclick="switchIconTab('china')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">China</button>
                                    <button type="button" class="btn btn-sm btn-outline" onclick="switchIconTab('japan')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">Japan</button>
                                    <button type="button" class="btn btn-sm btn-outline" onclick="switchIconTab('mascot')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">Mascot</button>
                                    <button type="button" class="btn btn-sm btn-outline" onclick="switchIconTab('onepiece')" style="flex-shrink: 0; border-radius: 12px; font-size: 0.65rem; padding: 2px 6px;">One Piece</button>
                                </div>
                                <div id="icon-grid" tabindex="0" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 6px; max-height: 160px; overflow-y: auto; outline: none; padding-right: 2px;">
                                    <!-- Rendered by JS -->
                                </div>
                                <div style="text-align: center; margin-top: 8px; font-size: 0.65rem; color: #94a3b8;"><i class="fa-solid fa-keyboard"></i> Use arrow keys to select</div>
                            </div>
                        </div>
                        ...
                        <div style="flex: 2 1 300px; display: flex; flex-direction: column; gap: 12px;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                                ...
                                <div class="form-group">
                                    <label style="font-size: 0.85rem; font-weight: 600; color: #475569; margin-bottom: 5px;">Installment / Month</label>
                            ...
                            <div style="padding: 10px 12px; background: rgba(241, 245, 249, 0.7); border-radius: 10px; border: 1px solid rgba(226, 232, 240, 0.8);">
                                <h4 style="margin: 0 0 8px 0; font-size: 0.8rem; color: #334155;"><i class="fa-solid fa-link"></i> Category Mapping</h4>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                    <div class="form-group" style="margin-bottom: 0;">
                                        <label style="font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 3px;">Principal</label>
                                    ...
                                    <div class="form-group" style="margin-bottom: 0;">
                                        <label style="font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 3px;">Interest</label>
